...
> [!NOTE]
> Ці питання перенесено в єдиний трекер — [`ops/wiki-backlog.md`](./wiki-backlog.md) (пункти B-20…B-25). Нижче лишено для історичного контексту; актуальний статус — у backlog.
