...
Цей документ — короткий вступ для будь-якого ШІ-агента, який працює з цією Wiki.
Якщо ви — ШІ, прочитайте це перед початком роботи.

> Канонічне і повне джерело правил — skill `skills/company-wiki/`
> (SKILL.md + references: таксономія, routing, frontmatter-схема, owner vocabulary,
> lint-правила, шаблони). Якщо цей файл і skill розходяться — правий skill.
...
Твої правила:
1. Визначай тип документа: policy / regulation / sop / instruction / checklist / incident / decision-log / brand (рідко).
